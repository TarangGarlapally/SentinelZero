...
if exist "%~dp0SentinelZero-Setup-v1.4.4.exe" (
    start "" "%~dp0SentinelZero-Setup-v1.4.4.exe"
) else if exist "%~dp0dist\SentinelZero-Setup-v1.4.4.exe" (
    start "" "%~dp0dist\SentinelZero-Setup-v1.4.4.exe"
) else (
